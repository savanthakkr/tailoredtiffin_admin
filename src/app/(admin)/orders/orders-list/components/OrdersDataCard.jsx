    ...
    <CardBody>
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="avatar-md bg-primary bg-opacity-10 rounded flex-centered">
          <IconifyIcon height={32} width={32} icon="mdi:food" className="text-primary" />
        </div>
      </div>
    </CardBody>
  </Card>
);
const OrdersDataCardPage = ({ kitchenData = [] }) => {
  return (
    <Row>
      {kitchenData.map((k, idx) => (
